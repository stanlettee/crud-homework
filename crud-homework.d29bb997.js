...
var _getMethod = require("./api/getMethod");
var _getMethodDefault = parcelHelpers.interopDefault(_getMethod);
var _postMethod = require("./api/postMethod");
var _postMethodDefault = parcelHelpers.interopDefault(_postMethod);
var _editMethod = require("./api/editMethod");
var _editMethodDefault = parcelHelpers.interopDefault(_editMethod);
var _deleteMethod = require("./api/deleteMethod");
var _deleteMethodDefault = parcelHelpers.interopDefault(_deleteMethod);
document.querySelector('#get-students-btn').addEventListener('click', ()=>{
    // getStudents()
    // return getStudents()
    (0, _getMethodDefault.default)().then((data)=>{
        console.log(data);
        document.querySelector("tbody").innerHTML = (0, _renderDefault.default)(data);
    });
});
document.querySelector('#add-student-form').addEventListener('submit', (e)=>{
    ...
    (0, _postMethodDefault.default)(studentObject).then(()=>{
        (0, _getMethodDefault.default)().then((data)=>{
            document.querySelector("tbody").innerHTML = (0, _renderDefault.default)(data);
        });
    });
...
document.querySelector('.editButt').addEventListener('click', ()=>{
    ...
    (0, _editMethodDefault.default)(updatedStudent, studentId).then(()=>(0, _getMethodDefault.default)()).then((data)=>{
        document.querySelector("tbody").innerHTML = (0, _renderDefault.default)(data);
...
document.querySelector('tbody').addEventListener('click', (e)=>{
    if (e.target.textContent === "\u0412\u0438\u0434\u0430\u043B\u0438\u0442\u0438") {
        ...
        (0, _deleteMethodDefault.default)(studentId).then(()=>{
            (0, _getMethodDefault.default)().then((data)=>{
                console.log(data);
                document.querySelector("tbody").innerHTML = (0, _renderDefault.default)(data);
            });
...
},{"./js/render":"dvMGd","./api/getMethod":"3HE4F","./api/postMethod":"8JP5e","./api/editMethod":"fidBO","./api/deleteMethod":"kFGQQ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dvMGd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>renderStudents);
...
},{}],"3HE4F":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>getStudents);
async function getStudents() {
    try {
        return await fetch("https://687ba9e9b4bc7cfbda86b8b5.mockapi.io/students/data/students").then((res)=>res.json());
    } catch (error) {
        console.log(error);
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8JP5e":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>addStudent);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fidBO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>updateStudent);
async function updateStudent(studentData, id) {
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kFGQQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7SvX3","kyksZ"], "kyksZ", "parcelRequire2d62", {})

//# sourceMappingURL=crud-homework.d29bb997.js.map
